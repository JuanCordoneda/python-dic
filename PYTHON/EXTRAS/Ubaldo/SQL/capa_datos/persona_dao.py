...
class PersonaDao:
    ...
    __INSERTAR = 'INSERT INTO persona(nombre, apellido, apodo) VALUES(%s,%s,%s)'
    __ACTUALIZAR = 'UPDATE persona SET nombre=%s, apellido=%s, apodo=%s WHERE id_persona=%s' 
    ...
    def insertar(cls, persona):
        try:
            ...
            valores = (persona.get_nombre(), persona.get_apellido(), persona.get_apodo())
    ...
    def actualizar(cls, persona):
        try:
            ...
            valores = (persona.get_nombre(), persona.get_apellido(), persona.get_apodo(), persona.get_id_persona())
